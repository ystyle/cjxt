...
5. **CSS**：Element Plus SCSS `public/scss/element-plus/`，编译后进 `bundle.css`
...
**解决**：从本地 `~/Projects/element-plus/packages/theme-chalk/src/menu.scss` 复制样式，加入 `element-plus.scss` 入口，重新编译 CSS 并同步到 examples。
**提交**：`8e1f332`
